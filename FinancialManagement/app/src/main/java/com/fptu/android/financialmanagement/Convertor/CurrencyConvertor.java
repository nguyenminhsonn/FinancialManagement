package com.fptu.android.financialmanagement.Convertor;
...
public class CurrencyConvertor extends AppCompatActivity {
    ...
    String[] country = {"USD","VND","INR","PHP"}; //ToDo
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Convertor");
        ...
        convertFromDropdownTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fromDialog = new Dialog(CurrencyConvertor.this);
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(CurrencyConvertor.this, android.R.layout.simple_list_item_1, arrayList);
        ...
        convertToDropdownTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                toDialog = new Dialog(CurrencyConvertor.this);
        ...
        convertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Double amountToConvert = Double.valueOf(CurrencyConvertor.this.amountToConvert.getText().toString());
    ...
    public String getConversionRate(String convertFrom, String convertTo, Double amountToConvert){
        ...
        String url = "https://free.currconv.com/api/v7/convert?q="+convertFrom+"_"+convertTo+"&compact=ultra&apiKey=530a4958b84629687414";
    ...
    public static double round(double value, int places){
        if(places<0) throw new IllegalStateException();
